...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('website/images/fav.png')}}" sizes="16x16">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-4">
            <br/>
            <p style="text-align: center;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> | All rights reserved <br> | Taka Samuha Nepal  | <br><a href="https://radiantnepal.com" target="_blank">Radiant InfoTech Nepal</a></p>
        </div>
    </div>
</div>
</body>
