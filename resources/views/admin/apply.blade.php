							...
							<div class="form-wrapper">
								<form action="{{route('contactstore')}}" method="POST" class="theme-form-one form-validation" autocomplete="on" enctype='multipart/form-data'>
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-6 col-12"><input type="text" placeholder="Subject *" name="subject"></div>
                                        <div class="col-sm-6 col-12"><input type="text" placeholder="Message *" name="message"></div>
